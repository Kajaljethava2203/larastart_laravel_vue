...
{{--            </div>--}}
{{--        </div>--}}
        <center><h2>L A R A S T A R T</h2></center>
    </nav>
    <!-- /.navbar -->
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="#" class="d-block">Kajal Jethava
{{--                        {{Auth::user()->name}}--}}
{{--                        <p>{{Auth::user()->type}}</p>--}}
                    </a>
                </div>
...
{{--                    </li>--}}
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2020-2022 <a href="https://adminlte.io">AdminLTE.io</a>.</strong> All rights reserved.
    </footer>
</div>
<!-- ./wrapper -->
